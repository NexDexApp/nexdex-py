...
This directory contains utility scripts for the NexDex Python SDK.

## Model Generation

### `generate_models_simple.py`

Fetches the NexDex API OpenAPI specification and generates Pydantic models.
...
- `--output-dir`: Output directory for generated models (default: `NexDex_py/api/generated`)

**What it does:**

1. Fetches the Swagger 2.0 spec from `https://api.prod.NexDex.trade/swagger/doc.json` OR uses a provided JSON file
...
4. Outputs models to `NexDex_py/api/generated/` (or custom directory)
5. Cleans up temporary files

**Generated files:**

- `NexDex_py/api/generated/model.py` - Base models
- `NexDex_py/api/generated/requests.py` - Request models
- `NexDex_py/api/generated/responses.py` - Response models
- `NexDex_py/api/generated/__init__.py` - Package initialization
