#!/usr/bin/env python3
"""
Example script demonstrating L2-only REST API usage with NexDexSubkey.
...
from nexdex_py import NexDex, NexDexSubkey
...
# Test Private API calls with L2-only authentication using NexDexSubkey
NexDex = NexDexSubkey(
    env=TESTNET,
