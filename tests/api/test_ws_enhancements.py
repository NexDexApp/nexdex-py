...
class TestWebSocketEnhancements:
    ...
    def setup_method(self):
        ...
        self.ws_client = NexDexWebsocketClient(env=TESTNET, auto_start_reader=False)
    ...
    def test_configurable_sleep_durations(self):
        ...
        client_custom = NexDexWebsocketClient(
            env=TESTNET,
            auto_start_reader=False,
    ...
    def test_ping_interval_configuration(self):
        ...
        client = NexDexWebsocketClient(env=TESTNET, auto_start_reader=False, ping_interval=30.0)
        assert client.ping_interval == 30.0

        # Test default ping interval (None)
        client_default = NexDexWebsocketClient(env=TESTNET, auto_start_reader=False)
    ...
    def test_disable_reconnect_configuration(self):
        ...
        client = NexDexWebsocketClient(env=TESTNET, auto_start_reader=False, disable_reconnect=True)
    ...
    def test_ws_url_override(self):
        ...
        client = NexDexWebsocketClient(env=TESTNET, auto_start_reader=False, ws_url_override=custom_url)
    ...
    def test_validate_messages_configuration(self):
        ...
        NexDexWebsocketClient(env=TESTNET, auto_start_reader=False, validate_messages=True)
...
class TestWebSocketMessageValidation:
    ...
    async def test_message_validation_enabled(self):
        ...
        client = NexDexWebsocketClient(env=TESTNET, auto_start_reader=False, validate_messages=True)
        ...
        with patch("nexdex_py.api.ws_client.validate_ws_message") as mock_validate:
    ...
    async def test_message_validation_disabled(self):
        ...
        client = NexDexWebsocketClient(env=TESTNET, auto_start_reader=False, validate_messages=False)
