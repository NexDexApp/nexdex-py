# Generated from NexDex API spec version 1.101.8
...
class BlockTradeSignature(BaseModel):
    ...
    signature_data: Annotated[
        str,
        Field(
            description='Order signature in as a string "[r,s]" signed by account\'s NexDex private key',
            examples=["0xabc123..."],
        ),
    ]
...
class MarketSummaryResp(BaseModel):
    ...
    mark_price: Annotated[
        str | None,
        Field(
            description="[Mark price](https://docs.NexDex.trade/risk-system/mark-price-calculation)",
...
class SystemConfigResponse(BaseModel):
    ...
    block_explorer_url: Annotated[
        ...
        Field(
            ...
            examples=["https://voyager.testnet.NexDex.trade/"],
        ),
    ] = None
    ...
    environment: Annotated[
        str | None, Field(description="Environment of the NexDex Instance", examples=["local"])
    ] = None
    ...
    starknet_fullnode_rpc_url: Annotated[
        ...
        Field(
            ...
            examples=["https://pathfinder.api.testnet.NexDex.trade/rpc/v0_7"],
        ),
    ] = None
...
class SystemTimeResponse(BaseModel):
    ...
    server_time: Annotated[str | None, Field(description="NexDex Server time", examples=["1681493415023"])] = None
...
class OrderResp(BaseModel):
    ...
    id: Annotated[
        str | None, Field(description="Unique order identifier generated by NexDex", examples=["123456"])
    ] = None
...
class TransferResult(BaseModel):
    ...
    txn_hash: Annotated[
        str | None,
        Field(
            description="Transaction hash on NexDex chain",
            examples=["0x495d2eb5236a12b8b4ad7d3849ce6a203ce21c43f473c248dfd5ce70d9454fa"],
        ),
    ] = None
...
class VaultResp(BaseModel):
    ...
    kind: Annotated[
        ...
        Field(
            description=(
                "Kind of the vault: 'user' for user-defined vaults, 'protocol' for vaults controlled by NexDex"
            ),
            examples=["user"],
        ),
    ] = None
